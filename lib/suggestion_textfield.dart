...
class AutoSuggestionTextField extends StatefulWidget {
  ...
  const AutoSuggestionTextField(
      {Key key,
        ...
        @required this.suggestionStrings, this.onValueChanged, this.suggestionBoxDecoration})
      : super(key: key);
  ...
  void _textListenerFunctionality() {
    if (widget.textController.text.length > 0) {
      ...
      if (matchedItems.length > 0) {
        ...
        if(matchedItems.length==1 && matchedItems[0]==widget.textController.text){
      ...
      children: <Widget>[
        ...
        Visibility(
          ...
          child: Container(
            ...
            decoration: widget.suggestionBoxDecoration ?? BoxDecoration(
              color: Colors.white,
